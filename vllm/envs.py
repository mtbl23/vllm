...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # instead of forcing TRITON_ATTN. This is deliberately opt-in and the
    # strict Verse runtime is the only supported caller.
    "VLLM_NVFP4_KV_VOSPLIT": lambda: bool(int(os.getenv("VLLM_NVFP4_KV_VOSPLIT", "0"))),
